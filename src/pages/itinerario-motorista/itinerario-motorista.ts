...
/**
 * Generated class for the ItinerarioMotoristaPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-itinerario-motorista',
  templateUrl: 'itinerario-motorista.html',
})
export class ItinerarioMotoristaPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,public _serviceRotaPassageiro: RotaPassageiroService, public _servicePassageiro: PassageiroService,
    ...
    this.van = this._seriveUsuario.van;
